...
impl Amount {
    ...
    #[deprecated(since = "TBD", note = "use from_u32_btc instead")]
    ...
    /// per bitcoin overflows a `u64` type.
    #[deprecated(since = "TBD", note = "use from_u32_btc_const instead")]
    ...
    pub fn from_u32_btc<T: Into<u32>>(whole_bitcoin: T) -> Result<Amount, OutOfRangeError> {
    ...
    ///
    /// If `whole_bitcoin` is greater than `21_000_000`.
    pub const fn from_u32_btc_const(whole_bitcoin: u32) -> Result<Amount, OutOfRangeError> {
        let btc = whole_bitcoin as u64; // Can't call u64::from in const context.
        let sats = btc * 100_000_000; // Don't need checked multiplication: u32::MAX * 100_000_000 < u64::MAX
        Self::from_sat(sats)
    }
